# S3 
S3 is Amazon's object storage service. It is designed to store and retrieve any amount of data from anywhere on the web. S3 is highly durable, highly available, and highly scalable. It can also be very cost effective if you select the right storage class and apply proper lifecycle policies.
